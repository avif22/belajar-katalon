...
WebUI.verifyElementPresent(findTestObject('Page_CURA Healthcare Service/label_Appoinment_Confirmation'), 30)

WebUI.verifyElementText(findTestObject('Page_CURA Healthcare Service/label_Appoinment_Confirmation'), 'Appointment Confirmation')
